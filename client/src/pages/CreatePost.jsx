  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        text-[#222328] text-[32px]'> Create
        </h1>
        <p className='mt-2 text-[#666e75] text-[14px] max-w [500px]'>
          Create images by DALL-E AI and share to the community
        </p>
      </div>
      <form className='mt-16 max-w-3xl'
       onSubmit={handleSubmit}>
        <div className='flex flex-col gap-5'>
          ...
          />
          <div className='relative bg-gray-50 border border
          -gray-300 text-gray-900 text-sm rounded-lg
          focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center'>
            ...
            { generatingImg &&(
              ...
              justify-center items-center bg-[rgb(0,0,0,0.5)]">
                <Loader/>
              </div>
            )
        ...
        <div className='mt-5 flex gap-5'>
          ...
          rounded-md text-sm w-full sm-auto px-5 py-2.5 text center'
          >
        ...
        <div className='mt-10'>
          ...
          <button type='submit' className='mt-3 text-white bg-[#6f4dab]
